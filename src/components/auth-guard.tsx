      ...
      <div className="flex min-h-screen items-center justify-center bg-muted/30 p-4">
        <Card className="w-full max-w-[400px] shadow-2xl border-t-4 border-t-primary">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription className="text-xs">Sistema StreamStock - Gestão de Estoque</CardDescription>
          </CardHeader>
            ...
            <CardContent className="space-y-4 pt-4">
              <div className="space-y-2">
                <Input
                  ...
                  className={`h-12 text-center text-lg ${error ? 'border-destructive focus-visible:ring-destructive animate-shake' : ''}`}
                  autoFocus
                />
                {error && (
